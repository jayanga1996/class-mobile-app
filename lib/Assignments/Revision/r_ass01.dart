...
class Ass01_r_Page extends StatefulWidget {
  Ass01_r_Page({Key key}) : super(key: key);

  @override
  _Ass01_r_PageState createState() => _Ass01_r_PageState();
}

// ignore: camel_case_types
class _Ass01_r_PageState extends State<Ass01_r_Page> {
  String urlPDFPath1 = "";
