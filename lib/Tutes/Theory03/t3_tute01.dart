...
class Tute01_t3_Page extends StatefulWidget {
  Tute01_t3_Page({Key key}) : super(key: key);

  @override
  _Tute01_t3_PageState createState() => _Tute01_t3_PageState();
}

// ignore: camel_case_types
class _Tute01_t3_PageState extends State<Tute01_t3_Page> {
  String urlPDFPath1 = "";
