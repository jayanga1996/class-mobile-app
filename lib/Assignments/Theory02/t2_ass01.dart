...
class Ass01_t2_Page extends StatefulWidget {
  Ass01_t2_Page({Key key}) : super(key: key);

  @override
  _Ass01_t2_PageState createState() => _Ass01_t2_PageState();
}

// ignore: camel_case_types
class _Ass01_t2_PageState extends State<Ass01_t2_Page> {
  String urlPDFPath1 = "";
