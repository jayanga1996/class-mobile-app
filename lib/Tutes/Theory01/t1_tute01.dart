...
class Tute01_t1_Page extends StatefulWidget {
  Tute01_t1_Page({Key key}) : super(key: key);

  @override
  _Tute01_t1_PageState createState() => _Tute01_t1_PageState();
}

// ignore: camel_case_types
class _Tute01_t1_PageState extends State<Tute01_t1_Page> {
  String urlPDFPath1 = "";
