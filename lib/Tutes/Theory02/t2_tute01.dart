...
class Tute01_t2_Page extends StatefulWidget {
  Tute01_t2_Page({Key key}) : super(key: key);

  @override
  _Tute01_t2_PageState createState() => _Tute01_t2_PageState();
}

// ignore: camel_case_types
class _Tute01_t2_PageState extends State<Tute01_t2_Page> {
  String urlPDFPath1 = "";
