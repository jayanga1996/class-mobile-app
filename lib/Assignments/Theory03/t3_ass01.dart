...
class Ass01_t3_Page extends StatefulWidget {
  Ass01_t3_Page({Key key}) : super(key: key);

  @override
  _Ass01_t3_PageState createState() => _Ass01_t3_PageState();
}

// ignore: camel_case_types
class _Ass01_t3_PageState extends State<Ass01_t3_Page> {
  String urlPDFPath1 = "";
