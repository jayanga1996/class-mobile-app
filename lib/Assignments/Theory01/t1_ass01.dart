...
class Ass01_t1_Page extends StatefulWidget {
  Ass01_t1_Page({Key key}) : super(key: key);

  @override
  _Ass01_t1_PageState createState() => _Ass01_t1_PageState();
}

// ignore: camel_case_types
class _Ass01_t1_PageState extends State<Ass01_t1_Page> {
  String urlPDFPath1 = "";
