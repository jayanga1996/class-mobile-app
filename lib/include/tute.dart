...
import 'package:goodbuy/Tutes/Theory01/t1_tute01.dart';

class TuteList extends StatefulWidget {
  @override
  _TuteListState createState() => _TuteListState();
}

final firestoreInstance = Firestore.instance;

class _TuteListState extends State<TuteList> {
                        ...
                        onPressed: () async {
                          ...
                          firestoreInstance
                            ...
                            if (register == regNumFieldTheory.text) {
                              setState(() {
                                regNumFieldTheory.text = 'Congratzz';
                                valid = true;
                              });
                            } else {
                              setState(() {
                                regNumFieldTheory.text = 'Looser';
                              });
                            }
                          });
                        },
              ...
              ? Padding(
                  ...
                  child: Container(
                    ...
                    child: RaisedButton(
                        ...
                        child: Text('Tute 01-Electronic'),
                        onPressed: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => Tute01_t1_Page(),
                              ));
                        }),
                  ),
                )
